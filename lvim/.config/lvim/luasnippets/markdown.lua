...
local function end_of_day(t)
  ...
  d.sec = 59
  t = os.time(d) 
  return snippet_date(t)
end

local function run(command)
  local handle = io.popen('brian task id /home/joaj/sources/wiki/journal/2023.md')
...
return {
  ...
  s("task-add", {t("(task-add "), f(function () return run("brian task task-id /home/joaj/sources/wiki/journal/2023.md") end), t(" d#"), f(function () return snippet_date(os.time()) end), t(" \""), i(1), t("\" :due d#"), i(2), t(")")}),
  s("task-done", {t("(task-done "), i(1), t(" d#"), f(function () return snippet_date(os.time()) end), t(")")}),
  s("task-drop", {t("(task-done "), i(1), t(" d#"), f(function () return snippet_date(os.time()) end), t(")")}),
  s("time-start", {t("(time-start "), t(" d#"), f(function () return snippet_date(os.time()) end), t(" )")}),
  s("time-stop", {t("(time-stop "), t(" d#"), f(function () return snippet_date(os.time()) end), t(" )")}),
}
