...
M.setup = function()
    ...
    wk.add({
        ...
        { "<loader>dl", function() require"osv".launch({port = 8086}) end, desc = "Launch nvim plugin (Dap)"},
        { "<loader>dw",  widgets.hover, desc = "Widgets Hover (Dap)" },
        { "<leader>df", function() widgets.centered_float(widgets.frames) end, desc = "Widgets Frames (Dap)" },
